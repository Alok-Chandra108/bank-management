    ...
    <div className="min-h-screen bg-emerald-950 flex items-center justify-center px-4 py-8">
      <div className="bg-emerald-900 border border-emerald-800 shadow-2xl rounded-2xl p-8 sm:p-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Sign in to your premium account</p>
        </div>
        ...
        <p className="text-center text-gray-400 mt-6">
          Don't have an account? <Link to="/" className="text-amber-300 hover:underline font-semibold transition duration-200">Register Here</Link>
        </p>
